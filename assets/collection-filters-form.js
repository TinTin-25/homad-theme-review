class FacetFiltersForm extends HTMLElement {
  ...
  static renderPage(searchParams, event, updateURLHash = true) {
    const bsOffcanvas = bootstrap.Offcanvas.getInstance('#offcanvasFilterBottom');
  ...
  static renderProductGridContainer(html) {
    ...
    // Trigger function after render HTML (Collection grid, Product card)
    $('body').trigger('collection:loadmore');
